      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 px-6">
        ...
        <div>
          ...
          <ul className="space-y-4 text-[#d7d2c9]">
            <Link href='/' className="flex items-center gap-2 hover:text-white cursor-pointer transition">
              <Info className="text-red-500" size={19} /> Ana Səhifə
            </Link>

            <Link href='/haqqimizda' className="flex items-center gap-2 hover:text-white cursor-pointer transition">
        ...
        <div>
          ...
          <ul className="space-y-4 text-[#d7d2c9]">
            ...
            <li className="flex items-center gap-3 hover:text-white cursor-pointer transition">
              ...
              <a
                href="https://www.instagram.com/qala.moo?igsh=MWtlbmY0ejB3aTRseA=="
                target="_blank"
            ...
            <li className="flex items-center gap-3 hover:text-white cursor-pointer transition">
              ...
              <a
                href="https://www.tiktok.com/@qalamoo?_r=1&_t=ZS-91fyxRZxpIX"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white cursor-pointer"
              >
